...
```{r table_content,fig.align='center',fig.width=10, fig.height=7, out.width="80%"}
...
```{r 2_identifiers,fig.align='center',fig.width=10, fig.height=7, out.width="80%", echo=FALSE}
...
```{r type_identifiers,fig.align='center',fig.width=10, fig.height=7, out.width="80%", echo=FALSE}
...
```{r minimization, fig.align='center',fig.width=10, fig.height=7, out.width="80%"}
...
```{r pseduni_anony,fig.align='center',fig.width=10, fig.height=7, out.width="80%"}
...
<!--chapter:end:03-pseudonymisation-anonymisation.Rmd-->
...
```{r distort,fig.align='center',fig.width=10, fig.height=7, out.width="80%"}
  knitr::include_graphics("figure/distort.png") 
```
```{r distort_2,fig.align='center',fig.width=10, fig.height=7, out.width="80%"}
...
```{r mask_textual,fig.align='center',fig.width=10, fig.height=7, out.width="80%"}
...
```{r mask_numeric,fig.align='center',fig.width=10, fig.height=7, out.width="80%"}
...
```{r rounding,fig.align='center',fig.width=10, fig.height=7, out.width="80%"}
...
```{r noise_addition,fig.align='center',fig.width=10, fig.height=7, out.width="80%"}
...
```{r audio_warning,fig.align='center',fig.width=10, fig.height=7, out.width="80%"}
...
```{r blurred_face,fig.align='center',fig.width=10, fig.height=7, out.width="80%"}
  knitr::include_graphics("figure/blurred_face.jpg") 
```

```{r blur_notice,fig.align='center',fig.width=10, fig.height=7, out.width="80%"}
...
```{r mute,fig.align='center',fig.width=10, fig.height=7, out.width="80%"}
...
```{r software_audio_video,fig.align='center',fig.width=10, fig.height=7, out.width="80%"}
...
```{r geo_data,fig.align='center',fig.width=10, fig.height=7, out.width="80%",fig.cap="Spatial aggregation of individual cases using census enumeration units (Paul A. Zandbergen, 2014)."}
...
```{r echo=FALSE}
webexercises::webex_radio(
  options = c("Earth", "Jupiter", "Mars", "Venus"),
  correct = "Jupiter",
